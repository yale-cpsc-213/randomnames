...
var natureAdjectives = []string{
	...
	"dark", "summer", "icy", "delicate", "quiet", "agile", "cool",
	"spring", "winter", "patient", "twilight", "dawn", "crimson", "wispy",
	"reverent", "billowing", "broken", "cold", "falling",
	"frosty", "ardent", "long", "late", "lingering", "bold", "little", "morning",
	"muddy", "valiant", "fiery", "rough", "clear", "superb", "sparkling", "throbbing",
	"prolific", "wandering", "withered", "wild", "awesome", "holy", "solitary",
	"fragrant", "noble", "snowy", "proud", "floral", "restless", "divine",
	"polished", "regal", "lively", "nameless", "puffy", "fluffy",
	"calm", "young", "golden", "avenging", "ancestral", "ancient", "argent",
	"reckless", "daunting", "swift", "rising", "strong", "tumbling",
